            ...
            <div className="flex-1 text-white">
               ...
               <div className="flex flex-col gap-20">
                  {Servicedata.map((service) => (
                     <div key={service.id} className="flex flex-col sm:flex-row gap-3 md:gap-8 lg:gap-10 items-center px-3 sm:px-5 py-5 rounded-2xl shadow-lg shadow-zinc-900 text-white">
